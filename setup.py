...
def create_roles(task_role_policy=None, ecs_role_policy='arn:aws:iam::aws:policy/AmazonECS_FullAccess',
                 ecs_agent_role_policy='arn:aws:iam::aws:policy/service-role/AmazonEC2ContainerServiceforEC2Role'):
    iam_client = boto3.client('iam')
...
def setup(project_name='spring-gigboard-rest',
          service_list={'spring-gigboard-rest-system': '8080','spring-gigboard-rest-owner': '8080', 'spring-petclinic-rest-pet': '8080','spring-petclinic-rest-vet': '8080','spring-petclinic-rest-visit': '8080'}
          , region='us-west-2'):
    ecr_client = boto3.client('ecr')
